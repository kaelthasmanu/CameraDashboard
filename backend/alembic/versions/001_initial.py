...
def upgrade():
    # Some early installations created these tables before Alembic began
    # tracking revisions.  Leave compatible existing tables in place so the
    # remaining migrations can bring the database up to date.
